...
<!-- Vendored from https://github.com/muratcankoylan/Agent-Skills-for-Context-Engineering (MIT).
     See ATTRIBUTION.md and LICENSE in this folder. Not authored by amaniagent. -->
...
2. **Observation masking** — Replace verbose tool outputs with compact references once their purpose has been served. Tool outputs can dominate agent trajectories, so masking often yields the largest capacity gains. The original content remains retrievable if needed downstream.
